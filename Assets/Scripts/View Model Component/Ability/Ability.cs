...
public class Ability : MonoBehaviour 
{
    ...
    public const string TurnConsumedNotification = "Ability.TurnConsumedNotification";
    public Sprite Icon;
	...
	public void Perform (List<HexCell> targets)
	{
		if (!CanPerform())
		{
	...
	public bool IsTarget (HexCell cell)
	{
